...
interface StateIconProps {
  ...
  className?: string;
  duration?: number;
  /** If provided, overrides internal auto-toggle and uses this value as the "on" state */
  controlled?: boolean;
}
...
/* 1. LOADING -> SUCCESS */
export function SuccessIcon({ size = 40, color = "currentColor", className, duration = 2200, controlled }: StateIconProps) {
  const done = useAutoToggle(duration, controlled);
  return (
...
/* 2. MENU -> CLOSE */
export function MenuCloseIcon({ size = 40, color = "currentColor", className, duration = 2000, controlled }: StateIconProps) {
  const open = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* 3. PLAY -> PAUSE */
export function PlayPauseIcon({ size = 40, color = "currentColor", className, duration = 2400, controlled }: StateIconProps) {
  const playing = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* 4. LOCK -> UNLOCK */
export function LockUnlockIcon({ size = 40, color = "currentColor", className, duration = 2600, controlled }: StateIconProps) {
  const unlocked = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* 5. COPY -> COPIED */
export function CopiedIcon({ size = 40, color = "currentColor", className, duration = 2200, controlled }: StateIconProps) {
  const copied = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* 6. BELL -> NOTIFICATION */
export function NotificationIcon({ size = 40, color = "currentColor", className, duration = 2800, controlled }: StateIconProps) {
  const notif = useAutoToggle(duration, controlled);
  return (
...
/* 7. HEART -> FILLED */
export function HeartIcon({ size = 40, color = "currentColor", className, duration = 2000, controlled }: StateIconProps) {
  const filled = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.path
...
/* 8. DOWNLOAD -> DONE */
export function DownloadDoneIcon({ size = 40, color = "currentColor", className, duration = 2400, controlled }: StateIconProps) {
  const done = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* 9. SEND */
export function SendIcon({ size = 40, color = "currentColor", className, duration = 2600, controlled }: StateIconProps) {
  const sent = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.g
...
/* 10. TOGGLE */
export function ToggleIcon({ size = 40, color = "currentColor", className, duration = 1800, controlled }: StateIconProps) {
  const on = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* 11. EYE -> HIDDEN */
export function EyeToggleIcon({ size = 40, color = "currentColor", className, duration = 2200, controlled }: StateIconProps) {
  const hidden = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* 12. VOLUME */
export function VolumeIcon({ size = 40, color = "currentColor", className, duration = 2400, controlled }: StateIconProps) {
  const muted = useAutoToggle(duration, controlled);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
